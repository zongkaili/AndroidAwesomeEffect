package com.kelly.effect.widget.pwdinput;
...
public class PwdEditText extends AppCompatEditText {
    ...
    private void setAttrs(AttributeSet attrs) {
        TypedArray t = mContext.obtainStyledAttributes(attrs, R.styleable.PwdEditText);
        if (t != null) {
            textLength = t.getInt(R.styleable.PwdEditText_textLength, 6);
            spaceX = t.getDimensionPixelSize(R.styleable.PwdEditText_space, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, getResources().getDisplayMetrics()));
            spaceY = t.getDimensionPixelSize(R.styleable.PwdEditText_space, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3, getResources().getDisplayMetrics()));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < textLength; i++) {
            ...
            RectF rect = new RectF(i * Wide + spaceX, spaceY, i * Wide + Wide - spaceX, Wide - spaceY); //四个值，分别代表4条线，距离起点位置的线
