...
@ARouter(path = "/app/JPMain2Activity")
public class JPMain2Activity extends AppCompatActivity {
    private static final String TAG = JPMain2Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jpmain2);
    }
